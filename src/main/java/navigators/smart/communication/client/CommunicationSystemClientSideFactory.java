...
public class CommunicationSystemClientSideFactory {
    public static CommunicationSystemClientSide getCommunicationSystemClientSide(TOMConfiguration conf){
         if (conf.clientServerCommSystem() == 1){
            return new NettyClientServerCommunicationSystemClientSide(conf);
         }
