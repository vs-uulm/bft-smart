...
public class Statistics {
	...
	try {
	    ...
	    //setup stats logging
	    serverstatswriter = new PrintWriter(new BufferedWriter(new FileWriter(SERVER_STATS_FILE)));
	    clientstatswriter = new PrintWriter(new BufferedWriter(new FileWriter(CLIENT_STATS_FILE)));
	} catch (IOException ex) {
	    Logger.getLogger(Statistics.class.getName()).log(Level.SEVERE, null, ex);
	    System.exit(1);
	}
	...
	serverstatswriter.println(crtt.getMean() + " " + rtt.getMean() + " " + dec.getMean());
